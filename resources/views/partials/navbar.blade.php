                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="has_dropdown">
                                                ...
                                                <div class="dropdown dropdown--menu">
                                                    <ul>
                                                        <li>
                                                            <a href="all-products.html">Featuered Products</a>
                                                        </li>
                                                        <li>
                                                            <a href="all-products.html">Newest Products</a>
                                                        </li>
                                                        <li>
                                                            <a href="index5.html">Discounted Products</a>
                                                        </li>
                                                        ...
                                                        <div class="menu_items">
                                                            ...
                                                            <div class="menu_column">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <a
                                                                            href="dashboard-withdrawal.html">Withdrawals</a>
                                                                    </li>
                                                                    <li>
                                            ...
                                            <div class="dropdown notification--dropdown">
                                                ...
                                                <div class="notifications_module">
                                                    ...
                                                    <div class="notification">
                                                        ...
                                                        <div class="notification__icons ">
                                                            <span
                                                                class="icon-basket-loaded purchased noti_icon"></span>
                                                        </div>
                                                        <!-- end /.notifications -->
                                                    </div>
                                                    <!-- end /.notifications -->
