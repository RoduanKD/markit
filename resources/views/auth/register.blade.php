            ...
            <div class="row">
                    ...
                    <form class="card card-md" action="{{ route('register') }}" method="post" autocomplete="off">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <label class="form-label mx-2">{{ __('Male') }}</label>
                ...
                @enderror
                            ...
                            <div class="form-footer">
                                <button type="submit"
                                    class="btn btn-primary w-100">{{ __('Create new account') }}</button>
                            </div>
                        </div>
                    </form>
                    ...
                    @if (Route::has('login'))
                        <div class="text-center text-muted mt-3">
                            {{ __('Already have account?') }} <a href="{{ route('login') }}"
                                tabindex="-1">{{ __('Sign in') }}</a>
                        </div>
                    @endif
                </div>
            </div>
